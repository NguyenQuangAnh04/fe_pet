    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="mb-6 pb-4 border-b border-gray-200">
        <h2 className="text-2xl font-bold text-gray-800">
          Tìm thấy <span className="text-blue-600">{data.content.length}</span>{" "}
          sản phẩm
        </h2>
      </div>
      ...
      {data.totalPages && data.totalPages > 1 && (
        <div className="flex gap-2 mt-8 pt-6 border-t border-gray-200 justify-center items-center">
          <button
            ...
            disabled={page === 0}
            className={`w-10 h-10 rounded-lg border-2 font-semibold transition-all duration-200 ${
              page === 0
          ...
          <button
            onClick={() =>
              setPage(page === data.totalPages - 1 ? page : page + 1)
            }
