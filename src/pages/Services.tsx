...
export default function Services() {
  ...
  const services: Service[] = [
    // Medical Services
    {
      ...
      description: 'Khám sức khỏe định kỳ, kiểm tra các chỉ số cơ bản của thú cưng',
      price: 200000,
      duration: '30-45 phút',
      icon: '🏥',
      category: 'medical'
    },
    {
      id: 2,
      name: 'Tiêm vaccine',
      description: 'Tiêm vaccine phòng bệnh cho chó mèo theo lịch trình khuyến nghị',
      price: 150000,
      duration: '15-20 phút',
      icon: '💉',
      category: 'medical'
    },
    {
      ...
      description: 'Khám và điều trị các bệnh lý chuyên sâu về da, tiêu hóa, tim mạch',
      price: 350000,
      duration: '45-60 phút',
      icon: '🔬',
      category: 'medical'
  ...
  const handleSubmitBooking = (e: React.FormEvent) => {
    ...
    // Validation
    const requiredFields: (keyof BookingForm)[] = ['petName', 'ownerName', 'phone', 'email', 'date', 'time'];
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6 min-h-screen">
        ...
        <div className="text-center mb-12 bg-gradient-to-r from-orange-50 to-blue-50 rounded-2xl p-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Chúng tôi cung cấp dịch vụ chăm sóc thú cưng toàn diện với đội ngũ bác sĩ thú y 
            và chuyên viên có kinh nghiệm, trang thiết bị hiện đại.
          </p>
        </div>
            ...
            <div key={service.id} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 mb-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-orange-600">{service.price.toLocaleString()}đ</span>
                </div>
                <div className="flex justify-between items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            <h3 className="font-semibold text-blue-900 mb-3">📞 Liên hệ khẩn cấp</h3>
            <p className="text-blue-800 text-sm mb-2">Hotline 24/7: <strong>0123-456-789</strong></p>
            <p className="text-blue-800 text-sm">Hỗ trợ khẩn cấp cho thú cưng mọi lúc</p>
          </div>

          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <h3 className="font-semibold text-green-900 mb-3">🏥 Đội ngũ chuyên nghiệp</h3>
            <p className="text-green-800 text-sm mb-2">Bác sĩ thú y có bằng cấp</p>
            <p className="text-green-800 text-sm">Kinh nghiệm hơn 10 năm chăm sóc thú cưng</p>
          </div>

          <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
            <h3 className="font-semibold text-purple-900 mb-3">🎯 Cam kết chất lượng</h3>
            <p className="text-purple-800 text-sm mb-2">Bảo hành dịch vụ</p>
            <p className="text-purple-800 text-sm">Hỗ trợ sau điều trị miễn phí</p>
          </div>
        </div>
              ...
              <div className="p-6">
                ...
                <form onSubmit={handleSubmitBooking} className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-4">Thông tin thú cưng</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBookingFormChange('petName', e.target.value)}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => handleBookingFormChange('petType', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Tuổi thú cưng</label>
                        <input
                          type="text"
                          value={bookingForm.petAge}
                          onChange={(e) => handleBookingFormChange('petAge', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  ...
                  {/* Owner Information */}
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-4">Thông tin chủ sở hữu</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <input
                          ...
                          onChange={(e) => handleBookingFormChange('ownerName', e.target.value)}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  ...
                  {/* Appointment Time */}
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-4">Thời gian hẹn</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                    <h4 className="font-medium text-orange-900 mb-2">Tóm tắt dịch vụ:</h4>
                    <div className="space-y-1 text-sm text-orange-800">
                      <p><strong>Dịch vụ:</strong> {selectedService.name}</p>
                      <p><strong>Thời gian:</strong> {selectedService.duration}</p>
                      <p><strong>Giá:</strong> {selectedService.price.toLocaleString()}đ</p>
                    </div>
                  </div>
