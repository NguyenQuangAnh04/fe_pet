...
const NewArrivals = () => {
  const product = [
    {
      id: 1,
      img: "https://paddy.vn/cdn/shop/files/hat-cho-meo-on25-cat-dam-cao.jpg?v=1755145247",
      img2: "https://paddy.vn/cdn/shop/files/hat-cho-meo-on25-cat-dam-cao_3_ed2193b6-7c98-4a89-b3f6-9a225fef5535.jpg?v=1755145247",
